...
('Manchester United','ENGLAND','#DA291C','#FBE122','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/thumb/7/7a/Manchester_United_FC_crest.svg/300px-Manchester_United_FC_crest.svg.png',array['Man United','MUFC']),
('Manchester City','ENGLAND','#6CABDD','#FFFFFF','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/thumb/e/eb/Manchester_City_FC_badge.svg/300px-Manchester_City_FC_badge.svg.png',array['Man City','MCFC']),
('Arsenal','ENGLAND','#EF0107','#FFFFFF','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/thumb/5/53/Arsenal_FC.svg/300px-Arsenal_FC.svg.png',array['Gunners']),
('Chelsea','ENGLAND','#034694','#FFFFFF','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/thumb/c/cc/Chelsea_FC.svg/300px-Chelsea_FC.svg.png',array['CFC']),
('Liverpool','ENGLAND','#C8102E','#FFFFFF','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/thumb/0/0c/Liverpool_FC.svg/300px-Liverpool_FC.svg.png',array['LFC']),
('Tottenham Hotspur','ENGLAND','#132257','#FFFFFF','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/thumb/b/b4/Tottenham_Hotspur.svg/300px-Tottenham_Hotspur.svg.png',array['Spurs']),
('Newcastle United','ENGLAND','#241F20','#FFFFFF','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/thumb/5/56/Newcastle_United_Logo.svg/300px-Newcastle_United_Logo.svg.png',array['Newcastle']),
...
('Brighton','ENGLAND','#0057B8','#FFFFFF','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/thumb/f/fd/Brighton_%26_Hove_Albion_logo.svg/300px-Brighton_%26_Hove_Albion_logo.svg.png',array['Brighton & Hove Albion']),
('West Ham United','ENGLAND','#7A263A','#1BB1E7','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/thumb/c/c2/West_Ham_United_FC_logo.svg/300px-West_Ham_United_FC_logo.svg.png',array['West Ham']),
...
('Villarreal','SPAIN','#FFE667','#00558C','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/thumb/b/b9/Villarreal_CF_logo.svg/300px-Villarreal_CF_logo.svg.png',array['Villarreal CF']),
...
('Inter Milan','ITALY','#010E80','#FFFFFF','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/thumb/0/05/FC_Internazionale_Milano_2021.svg/300px-FC_Internazionale_Milano_2021.svg.png',array['Inter']),
('AC Milan','ITALY','#FB090B','#000000','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Logo_of_AC_Milan.svg/300px-Logo_of_AC_Milan.svg.png',array['Milan']),
...
('Bayern Munich','GERMANY','#DC052D','#0066B2','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/thumb/1/1b/FC_Bayern_M%C3%BCnchen_logo_%282017%29.svg/300px-FC_Bayern_M%C3%BCnchen_logo_%282017%29.svg.png',array['Bayern']),
('Borussia Dortmund','GERMANY','#FDE100','#000000','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/thumb/6/67/Borussia_Dortmund_logo.svg/300px-Borussia_Dortmund_logo.svg.png',array['BVB']),
...
('Bayer Leverkusen','GERMANY','#E32221','#000000','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/thumb/5/59/Bayer_04_Leverkusen_logo.svg/300px-Bayer_04_Leverkusen_logo.svg.png',array['Leverkusen']),
('Paris Saint-Germain','FRANCE','#004170','#DA291C','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/thumb/a/a7/Paris_Saint-Germain_F.C..svg/300px-Paris_Saint-Germain_F.C..svg.png',array['PSG','Paris SG']),
...
('Inter Miami CF','USA','#F7B5CD','#000000','https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/thumb/5/5c/Inter_Miami_CF_logo.svg/300px-Inter_Miami_CF_logo.svg.png',array['Miami','Inter Miami']),
